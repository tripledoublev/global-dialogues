...
def compute_consensus_data(aggregate_std_df, verbatim_map_df, config, debug=False):
    ...
    if debug:
        print(f"Identified {len(strong_agree_thoughts)} thoughts with strong agreement")
        print(f"Identified {len(strong_disagree_thoughts)} thoughts with strong disagreement")
